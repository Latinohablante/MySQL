...
where year(fecha) = "2017" and total >= 300 and total <= 1000;
...
from pedido P
inner join comercial C, cliente Cl on P.id_comercial = C.id and Cl.id = P.id_cliente
where upper(Cl.nombre) = upper("Maria")